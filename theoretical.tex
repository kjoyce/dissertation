...
Observe that this set is precisely the preimage of $\KK^0$ under $T^\sharp$, and similar to the computation in \Cref{lem:innerProduct}, imposes a regularity on the shift of $p$.
