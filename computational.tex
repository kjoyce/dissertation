...
\end{equation}
for all events $A$, so taking $f(x) = 1 - \int\alpha(x,y')\pi_0(|y'-x|)dy'$ proves that $K(x,y)$ satisfies the detail balance condition, hence the Markov chain for \Cref{alg:metropolis} is invariant with respect to $\pi$.
\end{proof}
